...
import { faFacebook, faFontAwesome, faGoogle } from '@fortawesome/free-brands-svg-icons'
    ...
    return (
        <div className="container ">
                ...
                createNewUser ?
                    <Card className="w-50 mx-auto">
                        ...
                        <div className="w-100 text-center mt-2">
                            Already you have an account? <span className="text-success" href="" onClick={() => setCreateNewUser(!createNewUser)}>Log In</span>
                    ...
                    <Card className="w-50 mx-auto">
                        ...
                        <div className="w-100 text-center mt-2">
                            Don"t have an account? <span href="" className="text-success" onClick={() => setCreateNewUser(!createNewUser)}> create an account</span>
            ...
            <Form className="w-50 mx-auto">
                ...
                <Button className="w-100" variant="outline-secondary rounded-pill mb-4" onClick={handleGoogleSignIn} ><FontAwesomeIcon icon={faGoogle} color="green" />    Sign In With Google</Button>
                <Button type="submit" className="w-100  rounded-pill" variant="outline-secondary"><FontAwesomeIcon icon={faFacebook} color="blue" />  <span className="text-center">Sign In With Facebook</span></Button>
            </Form>
